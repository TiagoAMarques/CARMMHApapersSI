---
title: "Supplement S6: Assessing injury on GOM cetaceans"
author: ""
date: \today
output: 
...
The data for initial population sizes and proportion exposed are imported from a `txt` file produced inside [Supplement_S3](Supplement_S3.html).
