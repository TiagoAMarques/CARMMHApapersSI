...
This document briefly describes the initial population size and the the post oil population averaged survival. 

It simply reads in and then displays the distributions that we use as data.

For how these distributions are generated please see the dedicated spatial capture recapture (SCR) study by Glennie et al. 2021. In particular, we considered that the average of the population sizes in primary occasions 6 and 7 were a sensible approximation to the initial population size in April 2010.
