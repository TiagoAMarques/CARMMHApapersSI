...
* [BND_InitialPopulation.pdf](BND_InitialPopulation.html) – Initial population size distribution and baseline survival. These are taken as data inputs, and the deatil analysis that describes how these were obtained is part of a separate dedicated effort where a spatially explicit capture recapture model was implemented (Glennie et al.,2021).
