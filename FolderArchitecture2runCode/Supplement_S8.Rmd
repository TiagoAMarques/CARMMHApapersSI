---
title: "Supplement S8: Comparing model results with existing surveys"
author: ""
date:  \today
output: 
...
Details about the code used to produce the plots below is available in the corresponding ".Rmd" file ("ES7_ComparingWithSurveys.Rmd").
...
Some surveys are for a pair of years, and we first recodes these, for visual display purposes, as a single year value, corresponding to the the mid point between those successive years.
