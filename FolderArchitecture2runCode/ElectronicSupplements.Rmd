...
* [ElectronicSupplement1_EE](ElectronicSupplement1_EE.html) – Supplementary material about the expert elicitation exercises, which includes information about
...
* [ElectronicSupplement4_GD](ElectronicSupplement4_GD.html)  - Supplementary material with details about how we obtained gestation duration for each taxonomic unit considered, which gets used to scale survival and fecundity/reproduction related parameters.
...
* [GetInjury.pdf](GetInjury.html)  - the code for the production of all the injury measures presented on the paper; 

* [ModelEvaluation.pdf](ModelEvaluation.html) - the code for the production of all the sensitivity and uncertainty results presented on the paper.
