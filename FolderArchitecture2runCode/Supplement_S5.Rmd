---
title: "Supplement S5: Scaling survival and comparing survival across taxonomic units based on gestation duration"
author: ""
date: \today
output: 
...
The scaling is done by gestation duration, so we look at the gestation duration considered for each of the species. The rationale for each species gestation duration used is provided on a separate document included as a separate file: [Supplement_S4](Supplement_S4.html).
...
We present the scaled survivorship by taxonomic unit and sex below. For reference Barataria Bay bottlenose dolphins shown in green, sperm whale in blue and spinner dolphin in light blue
