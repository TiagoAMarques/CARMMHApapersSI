...
Following an elicitation on the shape of the density dependent fecundity response in bottlenose dolphins (see Schwacke et al in review), experts were asked the same question about sperm whales. The question was agreed as: “Given that the value of Rho will aﬀect the shape of the density dependent response of fecundity in offshore cetacean populations, what do you judge to be the most appropriate value for Rho for this species and population?”. The resulting distribution is shown below (Figure SI.1)
...
plot(x, q, type = "l", col = "springgreen4", lwd=2, xlim=c(0,28), xlab="Density Dependent 
shape parameter (Rho)", ylab="Density",cex.lab=1)

q3 <- dgamma(x, shape = 5.41, rate = 0.72)
lines(x + 3, q3, type = "l", lwd=2, col = "springgreen")
...
"springgreen", "dodgerblue"), lty = c(1,1,5), lwd=2, cex=1)
```


Figure S1.1 - Probability  distributions  showing  the  consensus  of  the  EE  for  the  value of Rho for Gulf of Mexico offshore cetacean species.
...
Figure S1.3 - Probability  distributions  showing  the  consensus  of  the  EE  for  the  proportional recovery of survival in Gulf of Mexico offshore cetacean species following DWH oiling.
