...
annotate("segment",x=MPD-1,xend=MPD-1,yend=data4$y,y=data4$yend,colour="black",linetype = "dashed", lwd=2, arrow = arrow(type="closed", length = unit(0.2, "inches")))+
...
We would like to thank Carolina Marques for the code and data wrangling that made the last plot.
