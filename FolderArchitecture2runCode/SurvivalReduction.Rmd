...
In this document we describe the required analysis to estimate a baseline survival and the post-oil spill survivalfor common bottlenose dolphins in Barataria Bay, which combined provide a survival reduction.
