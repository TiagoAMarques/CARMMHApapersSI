...
In case you are reading this document on git while browsing the material for the pelagic paper, the master file with supplementary material for the pelagic paper is here: [Electronic Supplements master file](ES0_ElectronicSupplements.html).
...
#------------------------------------------------------------
    ...
    M0 <- getM(na = na, dimm = ns*nc*na, femalesur = femalesur, malesur = malesur, srf = 1, ddfr = F0, frf = 1, a1stR = a1stRsim, alasR     = na)
    #------------------------------------------------------------
