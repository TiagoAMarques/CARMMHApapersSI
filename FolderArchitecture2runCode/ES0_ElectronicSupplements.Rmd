...
* 1.0 [date] Version included as a pdf Electronic Supplement in the MEPS original submission - *note to co-authors: this note will be deleted when we submit and we are not tracking versions prior to submitting to MEPS, so that will be version 1.0 by definition* 
