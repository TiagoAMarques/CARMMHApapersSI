...
* [ES3_GestationDuration](ES3_GestationDuration.html)  - Supplementary material with details about how we obtained gestation duration for each taxonomic unit considered, which gets used to scale survival and fecundity/reproduction related parameters.
...
An additional file might be relevant since it refers to the Age of Sexual Maturity (ASM) for *Tursiops truncatus*. We scale the values for *Tursiops truncatus* according to the gestation duration described in [ES3_GestationDuration](ES3_GestationDuration.html) 

* [AgeOfSexualMaturity](AgeOfSexualMaturity.html) - Supplementary material with details about how we obtained the age at sexual maturity for *Tursiops truncatus*. This is a file that was also used for Schwacke et al. (2021). 
